...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250727232423_Added Vendor Number")]
    partial class AddedVendorNumber
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Vendor", b =>
                {
                    ...
                    b.Property<string>("VendorNumber")
                        ...
                        .HasMaxLength(8)
                        .HasColumnType("nvarchar(8)")
                        .HasComputedColumnSql("CONCAT('VEN', RIGHT('00000' + CAST([SequentialNumber] AS VARCHAR(5)), 5))", true);
